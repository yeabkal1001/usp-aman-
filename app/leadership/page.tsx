...
const leadershipTestimonials = [
  {
    quote:
      "Dr. Henok's vision and leadership have transformed USP Holdings into an industry powerhouse.",
  ...
  {
    quote:
      "Under Yared's financial stewardship, we've achieved unprecedented growth and stability.",
  ...
  {
    quote:
      "Ben's operational excellence ensures every project exceeds client expectations.",
...
const leadershipCards = [
    ...
    content: (
      <div className="space-y-4">
        <p className="text-neutral-600 dark:text-neutral-200">
          Visionary leader who built USP Holdings from a single parking facility
          into a multi-industry powerhouse.
        </p>
        <div className="flex flex-wrap gap-2">
          <span className="px-2 py-1 bg-[#A9111D]/10 text-[#A9111D] text-xs rounded">
            Founder
          </span>
          <span className="px-2 py-1 bg-[#A9111D]/10 text-[#A9111D] text-xs rounded">
            25+ Years
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-neutral-600 dark:text-neutral-200">
          Financial strategist who co-founded United Investments and led
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p className="text-neutral-600 dark:text-neutral-200">
          Operations expert overseeing strategy and execution across all USP
          Holdings divisions.
        </p>
        <div className="flex flex-wrap gap-2">
          <span className="px-2 py-1 bg-[#A9111D]/10 text-[#A9111D] text-xs rounded">
  ...
  return (
    <div className="relative w-full bg-[#0C141F] overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
        ...
        />
        <Spotlight
          className="top-10 right-full h-[80vh] w-[50vw]"
          fill="white"
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative h-96 lg:h-[500px] rounded-lg overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg border border-[#0C141F]/10">
                    <h3 className="text-[#0C141F] font-medium text-lg mb-2">
                      Executive Leadership Team
                    </h3>
                    <p className="text-[#0C141F]/70 text-sm mb-4">
                      Decades of combined experience driving innovation and
                      growth
                    </p>
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-[#A9111D] font-bold">75+</div>
                        <div className="text-[#0C141F]/60 text-xs">
                          Years Combined
                        </div>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <div className="text-[#0C141F]/60 text-xs">Vision</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="text-center p-4 border border-[#0C141F]/20 rounded bg-[#A9111D]/5">
                  <div className="text-2xl text-[#A9111D] mb-2">🎯</div>
                  <div className="text-[#0C141F]/70 text-xs uppercase">
                    Visionary
                  </div>
                </div>
                <div className="text-center p-4 border border-[#0C141F]/20 rounded bg-[#A9111D]/5">
            ...
            >
              ...
              >
                <div className="text-sm text-[#A9111D] font-medium uppercase tracking-wide mb-4">
                  Meet Our Team
                </div>
                <h1 className="text-6xl lg:text-7xl font-light text-[#0C141F] mb-6 leading-tight">
                  Executive
                  <span className="text-[#A9111D] font-normal block">
                    Leadership
                  </span>
                </h1>
              ...
              >
                <TextGenerateEffect
                  ...
                  className="text-xl text-[#0C141F] leading-relaxed font-light mb-8"
                />
              </motion.div>
              ...
              >
                {[
                  {
                    principle: "Visionary Leadership",
                    desc: "Anticipating market trends and future opportunities",
                  },
                  {
                    principle: "Collaborative Excellence",
                    desc: "Working together to achieve collective success",
                  },
                  {
                    principle: "Sustainable Growth",
                    desc: "Long-term value creation for all stakeholders",
                  },
                ].map((item, index) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl font-light text-[#0C141F] mb-6">
                Leadership{" "}
                <span className="text-[#A9111D] font-normal">Excellence</span>
              </h2>
              <div className="w-24 h-px bg-[#A9111D] mb-8"></div>
              <p className="text-xl text-[#0C141F]/80 leading-relaxed font-light mb-8">
                Our executive team combines decades of industry experience with
                innovative vision to drive USP Holdings' continued growth and
                success.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "25+ years of consistent growth and industry leadership",
                  },
                  {
                    title: "Global Vision",
                    desc: "International expansion and strategic market positioning",
                  },
                  {
                    title: "Innovation Focus",
                    desc: "Sustainable development and cutting-edge solutions",
                  },
                ].map((item, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#A9111D] rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <div className="font-medium text-[#0C141F] mb-1">
                        {item.title}
                      </div>
                      <div className="text-[#0C141F]/70 text-sm">
                        {item.desc}
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-light text-white mb-6">
              Leadership{" "}
              <span className="text-[#A9111D] font-normal">Recognition</span>
            </h2>
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed font-light">
              What industry leaders and partners say about our executive team's
            ...
            {[
              {
                ...
                description:
                  "We believe in thinking beyond the present, anticipating future challenges and opportunities to drive innovation and growth.",
                icon: "🎯",
              },
              {
              ...
              >
                <div className="bg-white border border-[#0C141F]/10 rounded-xl p-8 hover:border-[#A9111D]/30 hover:shadow-xl transition-all duration-300">
                  ...
                  <h3 className="text-xl font-medium text-[#0C141F] mb-4">
                    {philosophy.title}
                  </h3>
