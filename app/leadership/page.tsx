            ...
            >
              <div className="relative h-96 lg:h-[500px] rounded-lg overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/80 backdrop-blur-sm p-6 rounded-lg border border-[#0C141F]/10">
                    <h3 className="text-[#0C141F] font-medium text-lg mb-2">Executive Leadership Team</h3>
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        ...
                        <div className="text-[#0C141F]/60 text-xs">Years Combined</div>
                      </div>
                      <div>
                        <div className="text-[#A9111D] font-bold">3</div>
                        <div className="text-[#0C141F]/60 text-xs">Divisions</div>
                      </div>
                      <div>
              ...
              >
                <div className="text-center p-4 border border-[#0C141F]/20 rounded bg-[#A9111D]/5">
                  ...
                  <div className="text-[#0C141F]/70 text-xs uppercase">Visionary</div>
                </div>
                <div className="text-center p-4 border border-[#0C141F]/20 rounded bg-[#A9111D]/5">
                  <div className="text-2xl text-[#A9111D] mb-2">🤝</div>
                  <div className="text-[#0C141F]/70 text-xs uppercase">Collaborative</div>
                </div>
                <div className="text-center p-4 border border-[#0C141F]/20 rounded bg-[#A9111D]/5">
                  <div className="text-2xl text-[#A9111D] mb-2">🌱</div>
                  <div className="text-[#0C141F]/70 text-xs uppercase">Sustainable</div>
                </div>
              </motion.div>
            </motion.div>
              ...
              >
                {[
                  ...
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      <div className="text-black font-medium mb-1">{item.principle}</div>
