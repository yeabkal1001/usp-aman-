...
export const TypewriterEffectSmooth = ({
    ...
    return (
      <div className="whitespace-nowrap lg:whitespace-normal">
        {wordsArray.map((word, idx) => {
          return (
            <span key={`word-${idx}`} className="inline lg:inline-block">
  ...
  return (
    <div className={cn("flex space-x-1 my-6 justify-center", className)}>
      ...
      >
        <div
          className="text-xs sm:text-base md:text-xl lg:text-3xl xl:text-5xl font-bold whitespace-nowrap lg:whitespace-normal"
        >
          {renderWords()}{" "}
        </div>{" "}
      </motion.div>
